...
For detailed instructions, see [Usage: Local deployment](usage/deployment.md#usage-local-deployment).
...
For detailed instructions, see [Usage: EKS deployment](usage/deployment.md#usage-eks-deployment).
