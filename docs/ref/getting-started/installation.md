...
```bash
docker pull wazuh/wazuh-indexer:5.1.0-alpha0
docker pull wazuh/wazuh-manager:5.1.0-alpha0
docker pull wazuh/wazuh-dashboard:5.1.0-alpha0
minikube image load wazuh/wazuh-indexer:5.1.0-alpha0
minikube image load wazuh/wazuh-manager:5.1.0-alpha0
minikube image load wazuh/wazuh-dashboard:5.1.0-alpha0
```
