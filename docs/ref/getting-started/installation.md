...
```bash
git clone https://github.com/wazuh/wazuh-kubernetes.git -b v0.0.1 --depth=1
cd wazuh-kubernetes
```
...
```bash
cd wazuh
curl -so wazuh-certs-tool.sh https://packages.wazuh.com/0.0/wazuh-certs-tool-0.0.1-1.sh
curl -so config.yml https://packages.wazuh.com/0.0/config-0.0.1-1.yml
```
...
```bash
docker pull wazuh/wazuh-indexer:0.0.1
docker pull wazuh/wazuh-manager:0.0.1
docker pull wazuh/wazuh-dashboard:0.0.1
minikube image load wazuh/wazuh-indexer:0.0.1
minikube image load wazuh/wazuh-manager:0.0.1
minikube image load wazuh/wazuh-dashboard:0.0.1
```
