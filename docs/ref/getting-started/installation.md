...
```bash
git clone https://github.com/wazuh/wazuh-kubernetes.git -b v4.14.8 --depth=1
cd wazuh-kubernetes
```
...
```bash
cd wazuh
curl -so wazuh-certs-tool.sh https://packages.wazuh.com/4.14/wazuh-certs-tool-4.14.8-1.sh
curl -so config.yml https://packages.wazuh.com/4.14/config-4.14.8-1.yml
```
...
```bash
docker pull wazuh/wazuh-indexer:4.14.8-alpha5
docker pull wazuh/wazuh-manager:4.14.8-alpha5
docker pull wazuh/wazuh-dashboard:4.14.8-alpha5
minikube image load wazuh/wazuh-indexer:4.14.8-alpha5
minikube image load wazuh/wazuh-manager:4.14.8-alpha5
minikube image load wazuh/wazuh-dashboard:4.14.8-alpha5
```
