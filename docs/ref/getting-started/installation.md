...
```bash
cd wazuh
curl -so wazuh-certs-tool.sh https://packages.wazuh.com/5.0/wazuh-certs-tool-5.2.0-1.sh
curl -so config.yml https://packages.wazuh.com/5.0/config-5.2.0-1.yml
```
