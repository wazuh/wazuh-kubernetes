...
```bash
docker pull wazuh/wazuh-indexer:5.0.0-beta4
docker pull wazuh/wazuh-manager:5.0.0-beta4
docker pull wazuh/wazuh-dashboard:5.0.0-beta4
minikube image load wazuh/wazuh-indexer:5.0.0-beta4
minikube image load wazuh/wazuh-manager:5.0.0-beta4
minikube image load wazuh/wazuh-dashboard:5.0.0-beta4
```
