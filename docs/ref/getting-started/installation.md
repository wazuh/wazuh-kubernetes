...
```bash
docker pull wazuh/wazuh-indexer:1.2.3
docker pull wazuh/wazuh-manager:1.2.3
docker pull wazuh/wazuh-dashboard:1.2.3
minikube image load wazuh/wazuh-indexer:1.2.3
minikube image load wazuh/wazuh-manager:1.2.3
minikube image load wazuh/wazuh-dashboard:1.2.3
```
