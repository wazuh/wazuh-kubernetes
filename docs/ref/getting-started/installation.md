...
```bash
git clone https://github.com/wazuh/wazuh-kubernetes.git -b v10.9.9 --depth=1
cd wazuh-kubernetes
```
...
```bash
cd wazuh
curl -so wazuh-certs-tool.sh https://packages.wazuh.com/10.9/wazuh-certs-tool-10.9.9-1.sh
curl -so config.yml https://packages.wazuh.com/10.9/config-10.9.9-1.yml
```
...
```bash
docker pull wazuh/wazuh-indexer:10.9.9
docker pull wazuh/wazuh-manager:10.9.9
docker pull wazuh/wazuh-dashboard:10.9.9
minikube image load wazuh/wazuh-indexer:10.9.9
minikube image load wazuh/wazuh-manager:10.9.9
minikube image load wazuh/wazuh-dashboard:10.9.9
```
