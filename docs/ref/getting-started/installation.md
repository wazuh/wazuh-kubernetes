...
```bash
git clone https://github.com/wazuh/wazuh-kubernetes.git -b v5.2.0 --depth=1
cd wazuh-kubernetes
```
...
```bash
cd wazuh
curl -so wazuh-certs-tool.sh https://packages.wazuh.com/5.2/wazuh-certs-tool-5.2.0-1.sh
curl -so config.yml https://packages.wazuh.com/5.2/config-5.2.0-1.yml
```
...
```bash
docker pull wazuh/wazuh-indexer:5.2.0
docker pull wazuh/wazuh-manager:5.2.0
docker pull wazuh/wazuh-dashboard:5.2.0
minikube image load wazuh/wazuh-indexer:5.2.0
minikube image load wazuh/wazuh-manager:5.2.0
minikube image load wazuh/wazuh-dashboard:5.2.0
```
