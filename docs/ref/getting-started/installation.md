...
```bash
docker pull wazuh/wazuh-indexer:5.0.0-alpha5
docker pull wazuh/wazuh-manager:5.0.0-alpha5
docker pull wazuh/wazuh-dashboard:5.0.0-alpha5
minikube image load wazuh/wazuh-indexer:5.0.0-alpha5
minikube image load wazuh/wazuh-manager:5.0.0-alpha5
minikube image load wazuh/wazuh-dashboard:5.0.0-alpha5
```
