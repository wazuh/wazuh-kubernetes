...
For details on what `kubernetes-local` and `kubernetes-eks` test types validate, see the [Integration Test Module — Description](https://documentation.xdrsiem.wazuh.info/repos/wazuh-automation/main/ref/integration_test_module/description.html).
