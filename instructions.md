...
Details:
- Image: Docker Hub 'wazuh/wazuh:3.13.4_7.9.2'
...
Details:
- Image: wazuh/wazuh-elasticsearch:3.13.4_7.9.2
- Controller: StatefulSet
...
Details:
- image: Docker Hub 'wazuh/kibana:3.13.4_7.9.2'
...
Details:
- image: Docker Hub 'wazuh/nginx:3.13.4_7.9.2'
- Controller: Deployment
