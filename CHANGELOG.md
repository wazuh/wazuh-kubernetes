...
| Issue | Comment |
| - | - |
| [#1638](https://github.com/wazuh/wazuh-kubernetes/issues/1638) | Document how to change the default Wazuh indexer and Wazuh API passwords, and add a check for default credentials. |
